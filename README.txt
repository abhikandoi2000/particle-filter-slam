...
.
├── SLAM.py                 # Main SLAM implementation file, has methods to do SLAM on entire dataset
├── transform.py            # transformation matrices and related helper function
├── dataset.py              # functions to load lidar and joint data (also timestamp based search)
